...
class ContextualEnricher:
    ...
    def __init__(self, doc_title: str = "Financial Document", doc_date: str = "Unknown"):
        ...
        self._client = None
        self._model_name = os.getenv("UTILITY_MODEL", "gemini-2.0-flash")
    ...
    def _generate_text(self, contents, max_output_tokens: int) -> str:
        """Generate text through the Google GenAI SDK with retry on rate limits."""
            ...
            try:
                ...
                if "429" in str(e) or "RESOURCE_EXHAUSTED" in str(e):
                    if attempt < max_retries:
                        ...
                        print(f"[ContextualEnricher] Rate limited. Waiting {wait}s (attempt {attempt+1}/{max_retries})...")
                        _time.sleep(wait)
                        continue
                raise
        return ""
